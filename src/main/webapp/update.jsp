...
<%@ page import="static com.controller.RegistrationController.updateUser" %>

<%
    // Retrieve values from the request parameters

    int userID = Integer.parseInt(request.getParameter("userIdI"));
...
//    String age = request.getParameter("ageI");
    ...
    try {
        updateUser(userID,fullName,address,phoneNumber,nicNumber,birthday,age,gender,email);
